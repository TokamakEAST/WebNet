...
$server    = '112.126.75.113';     // 服务器IP
$port      = 1883;            // 服务器端口
$username = 'wk';                   // set your username
$password = '123456';                   // set your password
$client_id = 'wk_010'; // make sure this is unique for connecting to sever - you could use uniqid()
...
$topics['wk'] = array('qos' => 0, 'function' => 'procMsg');
...
$topics['wk'] = array('qos' => 0, 'function' => 'processMessage'); // 修改函数名为 processMessage
...
function processMessage($topic, $msg)
{
    ...
    // $hum = $Qdata[3];
     ...
     $spe = floatval($Qdata[0]);
    $temp = floatval($Qdata[1]);
    $dir = floatval($Qdata[2]);
    $hum = floatval($Qdata[3]);


    $sql = "INSERT INTO wkqn (time,speed,temp,dire,hum)
    VALUES ('$time','$spe','$temp','$dir','$hum')";
