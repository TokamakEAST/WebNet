...
$port      = 1883;            // 服务器端口
$username = 'GAS';                   // set your username
$password = '123456';                   // set your password
$client_id = 'GAS_001'; // make sure this is unique for connecting to sever - you could use uniqid()
...
$topics['gas'] = array('qos' => 0, 'function' => 'procMsg');
...
$sql = "INSERT INTO Gas (time,CH4,H2S)
VALUES ('$time','$CH4','$H2S')";
